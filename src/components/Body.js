...
const Body = () => {
    ...
    <div className="contactMeDiv stickyItem">
        ...
        <div className="contactMeBody">
            ...
            <div className="iconContainer">
                <FaHashtag className="contactIcon"/>
                <a href="https://blog.danielhwile.com"><h4 className="contactLink">'Into The Wile' Blog</h4></a>
            </div>
            <div className="iconContainer">
                <FaTwitter className="contactIcon"/>
                <a href="https://twitter.com/danielhwile"><h4 className="contactLink">@danielhwile</h4></a>
            </div>
            <div className="iconContainer">
                <FaLinkedin className="contactIcon"/>
                <a href="https://www.linkedin.com/in/danielhwile/"><h4 className="contactLink">in/danielhwile</h4></a>
            </div>
            </div>
            </div>
